...
<div class="hero-static col-md-12 d-flex align-items-center bg-white">
        <div class="p-3 w-100 col-11 card shadow-sm border rounded rounded-4 col-md-4 mx-auto">
            ...
            <div class="mb-3 mt-5 text-center">
                ...
                <p class="text-uppercase font-w700 font-size-sm text-muted"> Admin Login</p>
            </div>
            <!-- END Header -->
            ...
            <div class="row no-gutters justify-content-center">
                <div class="col-sm-10 col-xl-8">
                    <form class="js-validation-signin mb-3" action="{{ route('login_process') }}" method="post">
                        @csrf
                        <div class="py-3">
                        ...
                        {{--  <div class="form-group ">
                            if you have not acount  <a href="{{ route('register') }}" class=" text-primary">Register Now</a>
                          </div>  --}}
                    </form>
                </div>
            </div>
