        ...
        <section id="dg-container" class="dg-container">
            <div class="dg-wrapper">
                <a href="#">
                    <div class="slider-container2">
                        <div class="slider-container1">
                            <img :src="'assets/images/Ellipse 16.png'" class="slider1" alt="girl image" />
                            <p style="font-size:24px; color:white; margin:0"> <b>Danish Gulsher</b> </p>
                            <p style="font-size:18px; color:white;">Lead designer</p>
                            <i class="fa-solid fa-quote-left mb-md-2" style="color: rgba(255, 122, 0, 1); font-size:22px"></i>
                            <div>
                                <p style="color:white">
                ...
                <a href="#">
                    <div class="slider-container2">
                        <div class="slider-container1">
                            <img :src="'assets/images/Ellipse 18.png'" class="slider1" alt="girl image" />
                            <p style="font-size:24px; color:white; margin:0 "> <b>Danish Gulsher</b> </p>
                            <p style="font-size:18px; color:white;">Lead designer</p>
                            <i class="fa-solid fa-quote-left mb-md-2" style="color: rgba(255, 122, 0, 1); font-size:22px"></i>
                            <div>
                ...
                <a href="#">
                    <div class="slider-container2">
                        <div class="slider-container1">
                            <img :src="'assets/images/Ellipse 17.png'" class="slider1" alt="girl image" />
                            <p style="font-size:24px; color:white; margin:0"> <b>Danish Gulsher</b> </p>
                            <p style="font-size:18px; color:white;">Lead designer</p>
                            <i class="fa-solid fa-quote-left mb-md-2" style="color: rgba(255, 122, 0, 1); font-size:22px"></i>
                            <div>
            ...
            <nav>
                <div class="justify-content-between d-flex">
                    <span class="dg-prev"><i class="fa-solid fa-chevron-left"></i></span>
                    <span class="dg-next"><i class="fa-solid fa-chevron-right"></i></span>
                </div>
                ...
                _getCoordinates: function (position) {
                    if (this.support3d) {
                        switch (position) {
                            ...
                            case 'left':
                                return {
                                    '-webkit-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-300px) rotateY(40deg)',
                                        '-moz-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-300px) rotateY(40deg)',
                                        '-o-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-300px) rotateY(40deg)',
                                        '-ms-transform': 'translateX(-' + this.CSSX + 'px) translateZ(-300px) rotateY(40deg)',
                                        'transform': 'translateX(-' + this.CSSX + 'px) translateZ(-300px) rotateY(40deg)',
                                        'opacity': 1,
                                        'visibility': 'visible'
                                };
                                break;
